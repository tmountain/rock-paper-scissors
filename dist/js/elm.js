...
var _user$project$RPS$Model = F2(
	function (a, b) {
		return {playerMove: a, randMove: b};
	});
var _user$project$RPS$Scissors = {ctor: 'Scissors'};
...
var _user$project$RPS$idxToMove = function (idx) {
	...
	switch (_p3) {
		...
		case 2:
			return _user$project$RPS$Paper;
		case 3:
			return _user$project$RPS$Scissors;
		default:
			return _user$project$RPS$Rock;
	}
};
var _user$project$RPS$genMove = A2(
	_elm_lang$core$Random$map,
	_user$project$RPS$idxToMove,
	A2(_elm_lang$core$Random$int, 1, 3));
var _user$project$RPS$NewMove = function (a) {
	return {ctor: 'NewMove', _0: a};
};
var _user$project$RPS$GenerateMove = {ctor: 'GenerateMove'};
var _user$project$RPS$update = F2(
	function (msg, model) {
		update:
		while (true) {
			var _p4 = msg;
			switch (_p4.ctor) {
				...
				case 'GenerateMove':
					return {
						ctor: '_Tuple2',
						_0: model,
						_1: A2(_elm_lang$core$Random$generate, _user$project$RPS$NewMove, _user$project$RPS$genMove)
					};
				default:
					return {
						ctor: '_Tuple2',
...
var _user$project$RPS$Choose = function (a) {
	return {ctor: 'Choose', _0: a};
};
var _user$project$RPS$Tie = {ctor: 'Tie'};
var _user$project$RPS$Lose = {ctor: 'Lose'};
...
var _user$project$RPS$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
			...
			_1: {
				...
				_0: A2(
					...
					},
					{
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$class('flex-item rock-item'),
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html_Events$onClick(
										_user$project$RPS$Choose(_user$project$RPS$Rock)),
									_1: {ctor: '[]'}
								}
							},
							{ctor: '[]'}),
						_1: {
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$class('flex-item paper-item'),
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html_Events$onClick(
											_user$project$RPS$Choose(_user$project$RPS$Paper)),
										_1: {ctor: '[]'}
									}
								},
								{ctor: '[]'}),
							_1: {
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$class('flex-item scissors-item'),
										_1: {
											ctor: '::',
											_0: _elm_lang$html$Html_Events$onClick(
												_user$project$RPS$Choose(_user$project$RPS$Scissors)),
											_1: {ctor: '[]'}
										}
									},
									{ctor: '[]'}),
				...
				_1: {
					ctor: '::',
					_0: _user$project$RPS$displayPlayerChoice(model),
					_1: {
						ctor: '::',
						_0: _user$project$RPS$displayOpponentChoice(model),
						_1: {
							ctor: '::',
							_0: A2(
								_elm_lang$html$Html$div,
								...
								},
								{
									...
									_0: _elm_lang$html$Html$text(
										A2(_user$project$RPS$outcomeToString, model.playerMove, model.randMove)),
									_1: {ctor: '[]'}
								}),
							_1: {ctor: '[]'}
						}
...
var _user$project$RPS$main = _elm_lang$html$Html$program(
	{
...
var Elm = {};
Elm['RPS'] = Elm['RPS'] || {};
if (typeof _user$project$RPS$main !== 'undefined') {
    _user$project$RPS$main(Elm['RPS'], 'RPS', undefined);
}
